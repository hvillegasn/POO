...
public class EmployeeTestInteractive {
    ...
    public static void main(String[] args)  {
        ...
        try  {
                IEmployeeDAO dao = factory.createEmployeeDAO();                
    ...
    public static boolean executeMenu(BufferedReader in, IEmployeeDAO dao) throws IOException, Exception {
        Employee emp;
        String action;
        int id;
    ...
    public static Employee inputEmployee(BufferedReader in, Employee empDefaults, boolean newEmployee) throws IOException {
        ...
        prompt = "Enter value for employee birth date (yyyy-mm-dd)"
                + ((empDefaults == null) ? "" : " [" + empDefaults.getBirthDate() + "]");
        do {
            System.out.println(prompt + " : ");
        ...
        prompt = "Enter float value for employee salary"
                + ((empDefaults == null) ? "" : " [" + empDefaults.getSalary() + "]");
        do {
            System.out.println(prompt + " : ");
            salary = 0;
            try {
